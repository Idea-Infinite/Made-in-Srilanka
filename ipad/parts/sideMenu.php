<div data-role="panel" data-display="overlay" data-position-fixed="true" id="sideMenu"
    ...
    <table class="side-menu" style="text-align: center">
        <tr>
            <td><a href="../pages/home.php"><img src="../../common/assets/images/icons/home.png" width="35" height="35"><br/>Home</a>
            </td>
            <td><a href="../pages/booking.php"><img src="../../common/assets/images/icons/booking.png" width="35"
                                                    height="35"><br/>Book Class</a></td>
            <td><a href="../pages/contactUs.php"><img src="../../common/assets/images/icons/contact_us.png" width="35"
                                                      height="35"><br/>Contact Us</a></td>
        </tr>
        <tr>
            <td><a href="../pages/shop.php"><img src="../../common/assets/images/icons/shop.png" width="35" height="35"><br/>Shop</a>
            </td>
            <td><a href="../pages/orderHistory.php"><img src="../../common/assets/images/icons/order_history.png"
                                                         width="35" height="35"><br/>Order History</a></td>
            <td><a href="../pages/about.php"><img src="../../common/assets/images/icons/icons8_information_96px.png"
        ...
        <tr>
            ...
            <td><a href="../pages/sellWithUs.php"><img src="../../common/assets/images/icons/cash.png" width="35"
                                                       height="35"><br/>Sell with Us</a></td>
            <td><a href="#popupDialog" data-rel="popup" data-position-to="window" data-transition="pop"><img
